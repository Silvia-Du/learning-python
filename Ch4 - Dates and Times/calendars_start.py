...
c = calendar.TextCalendar(calendar.MONDAY) #(da che gg deve partire)
str = c.formatmonth(2022, 1, 0, 0)
print(str)


# TODO: create an HTML formatted calendar
hc = calendar.HTMLCalendar(calendar.SUNDAY) #crea calendario in fomrmato html da poter copiare : 
...
for i in c.itermonthdays(2022, 8):
  print(i) #ritotìrna il n che rapp ogni ggg nel mese
